 ...
 */
object SparkDataFramesWithJoins {
...
//    This last part is equals to the next code //easier to use this method

      import sqlContext.sql

      flights.registerTempTable("flight")
      ...
      flights_between_airports_sql.registerTempTable("fbasql") //prepare for the next query

      val fba = flights_between_airports
      val air = airports //alias
